            ...
            <div>
              <Card className="sticky top-32 rounded-3xl border-[#ded5ca] bg-[#fbf9f5] p-6">
                ...
                <div className="mb-6 space-y-4">
                  <div className="flex justify-between"><span className="text-[#6d6259]">Sous-total</span><span className="font-semibold">€{total.toFixed(2)}</span></div>
                  <div className="flex justify-between"><span className="text-[#6d6259]">Livraison</span><span className="font-semibold">{total >= 50 ? "Gratuite" : "€9.99"}</span></div>
                  <div className="flex justify-between"><span className="text-[#6d6259]">TVA (20%)</span><span className="font-semibold">€{(total * 0.2).toFixed(2)}</span></div>
                </div>
                <div className="mb-6 border-t border-[#e3dbd1] pt-6"><div className="flex items-center justify-between"><span className="text-lg font-semibold">Total</span><span className="text-2xl font-semibold text-[#b65f3f]">€{(total * 1.2 + (total >= 50 ? 0 : 9.99)).toFixed(2)}</span></div></div>
