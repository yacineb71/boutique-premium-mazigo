      ...
      <div className="space-y-6">
        <section className="rounded-[1.5rem] border border-[#eadfd4] bg-gradient-to-br from-[#fffaf3] to-[#f4e9df] p-6 sm:p-8">
          ...
          <div className="mt-3 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            ...
            <button type="button" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-[#b65f3f] px-5 text-sm font-semibold text-white hover:bg-[#964b32]"><Plus size={16} /> Nouveau message</button>
          </div>
        </section>
